...
class MultiTrackerExample: UIViewController, UIGestureRecognizerDelegate {
    ...
    fileprivate lazy fileprivate(set) var chartLongPressGestureRecognizer = UILongPressGestureRecognizer()
    
    // MARK: – Chart configuration
    
    fileprivate lazy fileprivate(set) var chartSettings: ChartSettings = {
    ...
    fileprivate let axisLabelSettings: ChartLabelSettings = ChartLabelSettings()
    
    fileprivate let guideLinesLayerSettings: ChartGuideLinesLayerSettings = ChartGuideLinesLayerSettings()
    
    fileprivate lazy fileprivate(set) var axisLineColor = UIColor.clear
