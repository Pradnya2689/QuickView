...
class MultipleAxesInteractiveExample: UIViewController {
    ...
    init() {
        ...
        func createChartPoint(_ x: Double, y: Double, labelColor: UIColor) -> ChartPoint {
        ...
        func createChartPoints0(_ color: UIColor) -> [ChartPoint] {
            return [
                createChartPoint(0, y: 0, labelColor: color),
                createChartPoint(2, y: 2, labelColor: color),
                createChartPoint(5, y: 2, labelColor: color),
                createChartPoint(8, y: 11, labelColor: color),
                createChartPoint(10, y: 2, labelColor: color),
                createChartPoint(12, y: 3, labelColor: color),
                createChartPoint(16, y: 22, labelColor: color),
                createChartPoint(20, y: 5, labelColor: color)
            ]
        }
        
        func createChartPoints1(_ color: UIColor) -> [ChartPoint] {
            return [
                createChartPoint(0, y: 7, labelColor: color),
                createChartPoint(1, y: 10, labelColor: color),
                createChartPoint(3, y: 9, labelColor: color),
                createChartPoint(9, y: 2, labelColor: color),
                createChartPoint(10, y: -5, labelColor: color),
                createChartPoint(13, y: -12, labelColor: color)
            ]
        }
        
        func createChartPoints2(_ color: UIColor) -> [ChartPoint] {
            return [
                createChartPoint(-200, y: -10, labelColor: color),
                createChartPoint(-160, y: -30, labelColor: color),
                createChartPoint(-110, y: -10, labelColor: color),
                createChartPoint(-40, y: -80, labelColor: color),
                createChartPoint(-10, y: -50, labelColor: color),
                createChartPoint(20, y: 10, labelColor: color)
            ]
        }
        
        func createChartPoints3(_ color: UIColor) -> [ChartPoint] {
            return [
                createChartPoint(10000, y: 70, labelColor: color),
                createChartPoint(20000, y: 100, labelColor: color),
                createChartPoint(30000, y: 160, labelColor: color)
            ]
        }
    ...
    fileprivate func createLineLayers(_ animDuration: Float) -> [ChartPointsLineLayer<ChartPoint>] {
    ...
    fileprivate func createLayers(_ selectedLayersFlags: [Bool], showGuides: Bool, lineAnimDuration: Float) -> ([ChartLayer]) {
        
        var axisLayers: [ChartLayer] = []
        var itemsLayers: [ChartLayer] = []
        
        let lineLayers = createLineLayers(lineAnimDuration)
        
        func group(_ xAxis: ChartAxisLayer, yAxis: ChartAxisLayer, lineLayer: ChartLayer, guideLayer: ChartLayer) -> [ChartLayer] {
            return [xAxis, yAxis, lineLayer] + (showGuides ? [guideLayer] : [])
        }
        
        let layers: [[ChartLayer]] = [
            group(xLowAxesLayers[0], yAxis: yLowAxesLayers[1], lineLayer: lineLayers[0], guideLayer: guideLinesLayer0),
            group(xLowAxesLayers[1], yAxis: yLowAxesLayers[0], lineLayer: lineLayers[1], guideLayer: guideLinesLayer1),
            group(xHighAxesLayers[1], yAxis: yHighAxesLayers[0], lineLayer: lineLayers[2], guideLayer: guideLinesLayer2),
            group(xHighAxesLayers[0], yAxis: yHighAxesLayers[1], lineLayer: lineLayers[3], guideLayer: guideLinesLayer3)
        ]
    ...
    fileprivate func showChart(_ chartSettings: ChartSettings, lineAnimDuration: Float) -> () {
        ...
        let layers = createLayers(selectedLayersFlags, showGuides: showGuides, lineAnimDuration: lineAnimDuration)
