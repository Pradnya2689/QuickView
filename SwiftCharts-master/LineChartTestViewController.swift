...
class LineChartTestViewController: UIViewController {
...
//        let xValues = ChartAxisValuesStaticGenerator.generateXAxisValuesWithChartPoints(chartPoints, minSegmentCount: 5, maxSegmentCount: 10, multiple: 10, axisValueGenerator: {ChartAxisValueDouble($0, labelSettings: labelSettings)}, addPaddingSegmentIfEdge: false)
        ...
        // let touchLayer = ChartPointsViewsLayer(xAxis: xAxisLayer.axis, yAxis: yAxisLayer.axis, chartPoints: chartPoints, mode: .translate, keepOnFront: true)
        // UIColor.init(red: 255/255.0, green: 112/255.0, blue: 186/255.0, alpha: 0.8)
        let lineModel = ChartLineModel(chartPoints: chartPoints, lineColor: UIColor(red: 255/255.0, green: 112/255.0, blue: 186/255.0, alpha: 0.2), lineWidth: 3, animDuration: 0.7, animDelay: 0)
        ...
        let circleViewGenerator = {(chartPointModel: ChartPointLayerModel, layer: ChartPointsLayer, chart: Chart) -> UIView? in
            ...
            circleView.borderColor = UIColor.init(red: 204/255.0, green: 0/255.0, blue: 105/255.0, alpha: 0.8)
            return circleView
        }
...
//        let xValues = ChartAxisValuesStaticGenerator.generateXAxisValuesWithChartPoints(chartPoints, minSegmentCount: 4, maxSegmentCount: 10, multiple: 2, axisValueGenerator: {ChartAxisValueDouble($0, labelSettings: labelSettings)}, addPaddingSegmentIfEdge: false)
        
        let xValues = ChartAxisValuesStaticGenerator.generateXAxisValuesWithChartPoints(chartPoints, minSegmentCount: 12, maxSegmentCount: 12, multiple: 2, axisValueGenerator: {ChartAxisValueDouble($0, labelSettings: labelSettings)}, addPaddingSegmentIfEdge: false)

        let yValues = ChartAxisValuesStaticGenerator.generateYAxisValuesWithChartPoints(chartPoints, minSegmentCount: 10, maxSegmentCount: 20, multiple: 50, axisValueGenerator: {ChartAxisValueDouble($0, labelSettings: labelSettings)}, addPaddingSegmentIfEdge: true)
